 ...
 * @author Sulenni
 */
public class frm_TipoPss extends javax.swing.JInternalFrame {
        AfiliadoDao afiliadoDao;
        Tipo_PssDto tipoPssDto;
    /**
     * Creates new form frm_TipoPss
     */
    public frm_TipoPss() throws Exception {
        initComponents();
        
        afiliadoDao = new AfiliadoDao();
        tipoPssDto = new Tipo_PssDto();
        
        
        jtblTipoPss.setModel(afiliadoDao.getModelTipoPss(afiliadoDao.GetAllTipoPss()));
        RedisenarTablaTipoPss();
        SeleccionarPrimero();
    }
    
    public void RedisenarTablaTipoPss(){
        //jtblAfiliado.setTableHeader(null);
        jtblTipoPss.removeColumn(jtblTipoPss.getColumnModel().getColumn(1));
    ...
    private void initComponents() {
        ...
        jtblTipoPss = new javax.swing.JTable();
        jtxtBuscarTipoPss = new javax.swing.JTextField();
        ...
        jlblAnalisis.setText("FORMULARIO TIPO PSS");
        ...
        jtblTipoPss.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jtblTipoPss.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtblTipoPss.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jtblTipoPssMousePressed(evt);
            }
        });
        jtblTipoPss.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtblTipoPssKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jtblTipoPss);

        jtxtBuscarTipoPss.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtBuscarTipoPssKeyTyped(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jtxtBuscarTipoPss, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtxtBuscarTipoPss, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
...
//            }
            ...
            if (component instanceof JTextField){
                ...
                if(tf.getText().isEmpty()){
                    ...
                    if (jlblId.getText().isEmpty()){
                        try {
                            tipoPssDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.insertTipoPss(tipoPssDto);
                            } catch (Exception ex) {
                                Logger.getLogger(frm_TipoPss.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        try {
                            jtblTipoPss.setModel(afiliadoDao.getModelTipoPss(afiliadoDao.GetAllTipoPss()));
                        } catch (SQLException ex) {
                            ...
                            RedisenarTablaTipoPss();
                            SeleccionarPrimero();
                            jtblTipoPss.getSelectionModel().addSelectionInterval(0, 0);
                            jtxtNombre.setText((String) (jtblTipoPss.getModel().getValueAt(jtblTipoPss.getSelectedRow(), 0)));
                            jlblId.setText(Integer.toString((int) jtblTipoPss.getModel().getValueAt(jtblTipoPss.getSelectedRow(), 1)));
                   
                    } else {
                        try {
                            tipoPssDto.setId(Integer.parseInt(jlblId.getText()));
                            tipoPssDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.updateTipoPss(tipoPssDto);
    ...
    private void jtblTipoPssMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblTipoPssMousePressed
            
        PasarACampos();
        
    }//GEN-LAST:event_jtblTipoPssMousePressed
    ...
    private void jtxtBuscarTipoPssKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBuscarTipoPssKeyTyped

        
        try {
                jtblTipoPss.setModel(afiliadoDao.filtraModelTipoPss(jtxtBuscarTipoPss.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(frm_TipoPss.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            RedisenarTablaTipoPss();
            SeleccionarPrimero();
    }//GEN-LAST:event_jtxtBuscarTipoPssKeyTyped
    ...
    private void jbttNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttNuevo1ActionPerformed
        ...
        afiliadoDao.deleteTipoPss(tipoPssDto);
        try {
            jtblTipoPss.setModel(afiliadoDao.getModelTipoPss(afiliadoDao.GetAllTipoPss()));
    ...
    private void jtblTipoPssKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtblTipoPssKeyReleased
        if(evt.getKeyCode()==40||evt.getKeyCode()==38){
            
            PasarACampos();
        }
    }//GEN-LAST:event_jtblTipoPssKeyReleased

    private void SeleccionarPrimero(){
        
        try {
            if(jtblTipoPss.getModel().getValueAt(0, 0)!=null){
            jtblTipoPss.setRowSelectionInterval(0, 0);
            PasarACampos();
        }
        } catch (Exception e) {
        }
    ...
    private javax.swing.JTable jtblTipoPss;
    private javax.swing.JTextField jtxtBuscarTipoPss;
