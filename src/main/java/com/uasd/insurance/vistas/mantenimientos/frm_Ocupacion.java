 ...
 * @author Sulenni
 */
public class frm_Ocupacion extends javax.swing.JInternalFrame {
        AfiliadoDao afiliadoDao;
        OcupacionDto ocupacionDto;
    /**
     * Creates new form frm_Ocupacion
     */
    public frm_Ocupacion() throws Exception {
        initComponents();
        
        afiliadoDao = new AfiliadoDao();
        ocupacionDto = new OcupacionDto();
        
        
        jtblOcupacion.setModel(afiliadoDao.getModelOcupacion(afiliadoDao.GetAllOcupacion()));
        RedisenarTablaOcupacion();
        SeleccionarPrimero();
    }
    
    public void RedisenarTablaOcupacion(){
        //jtblAfiliado.setTableHeader(null);
        jtblOcupacion.removeColumn(jtblOcupacion.getColumnModel().getColumn(1));
    ...
    private void initComponents() {
        ...
        jtblOcupacion = new javax.swing.JTable();
        jtxtBuscarOcupacion = new javax.swing.JTextField();
        ...
        jlblAnalisis.setText("FORMULARIO OCUPACION");
        ...
        jtblOcupacion.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jtblOcupacion.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtblOcupacion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jtblOcupacionMousePressed(evt);
            }
        });
        jtblOcupacion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtblOcupacionKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jtblOcupacion);

        jtxtBuscarOcupacion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtBuscarOcupacionKeyTyped(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jtxtBuscarOcupacion, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtxtBuscarOcupacion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
...
//            }
            ...
            if (component instanceof JTextField){
                ...
                if(tf.getText().isEmpty()){
                    ...
                    if (jlblId.getText().isEmpty()){
                        try {
                            ocupacionDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.insertOcupacion(ocupacionDto);
                            } catch (Exception ex) {
                                Logger.getLogger(frm_Ocupacion.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        try {
                            jtblOcupacion.setModel(afiliadoDao.getModelOcupacion(afiliadoDao.GetAllOcupacion()));
                        } catch (SQLException ex) {
                            ...
                            RedisenarTablaOcupacion();
                            SeleccionarPrimero();
                            jtblOcupacion.getSelectionModel().addSelectionInterval(0, 0);
                            jtxtNombre.setText((String) (jtblOcupacion.getModel().getValueAt(jtblOcupacion.getSelectedRow(), 0)));
                            jlblId.setText(Integer.toString((int) jtblOcupacion.getModel().getValueAt(jtblOcupacion.getSelectedRow(), 1)));
                   
                    } else {
                        try {
                            ocupacionDto.setId(Integer.parseInt(jlblId.getText()));
                            ocupacionDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.updateOcupacion(ocupacionDto);
    ...
    private void jtblOcupacionMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblOcupacionMousePressed
            
        PasarACampos();
        
    }//GEN-LAST:event_jtblOcupacionMousePressed
    ...
    private void jtxtBuscarOcupacionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBuscarOcupacionKeyTyped

        
        try {
                jtblOcupacion.setModel(afiliadoDao.filtraModelOcupacion(jtxtBuscarOcupacion.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(frm_Ocupacion.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            RedisenarTablaOcupacion();
            SeleccionarPrimero();
    }//GEN-LAST:event_jtxtBuscarOcupacionKeyTyped
    ...
    private void jbttNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttNuevo1ActionPerformed
        ...
        afiliadoDao.deleteOcupacion(ocupacionDto);
        try {
            jtblOcupacion.setModel(afiliadoDao.getModelOcupacion(afiliadoDao.GetAllOcupacion()));
    ...
    private void jtblOcupacionKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtblOcupacionKeyReleased
        if(evt.getKeyCode()==40||evt.getKeyCode()==38){
            
            PasarACampos();
        }
    }//GEN-LAST:event_jtblOcupacionKeyReleased

    private void SeleccionarPrimero(){
        
        try {
            if(jtblOcupacion.getModel().getValueAt(0, 0)!=null){
            jtblOcupacion.setRowSelectionInterval(0, 0);
            PasarACampos();
        }
        } catch (Exception e) {
        }
    ...
    private javax.swing.JTable jtblOcupacion;
    private javax.swing.JTextField jtxtBuscarOcupacion;
