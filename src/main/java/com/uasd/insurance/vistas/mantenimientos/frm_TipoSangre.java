 ...
 * @author Sulenni
 */
public class frm_TipoSangre extends javax.swing.JInternalFrame {
        AfiliadoDao afiliadoDao;
        Tipo_SangreDto tipoSangreDto;
    /**
     * Creates new form frm_TipoSangre
     */
    public frm_TipoSangre() throws Exception {
        initComponents();
        
        afiliadoDao = new AfiliadoDao();
        tipoSangreDto = new Tipo_SangreDto();
        
        
        jtblTipoSangre.setModel(afiliadoDao.getModelTipoSangre(afiliadoDao.GetAllTipoSangre()));
        RedisenarTablaTipoSangre();
        SeleccionarPrimero();
    }
    
    public void RedisenarTablaTipoSangre(){
        //jtblAfiliado.setTableHeader(null);
        jtblTipoSangre.removeColumn(jtblTipoSangre.getColumnModel().getColumn(1));
    ...
    private void initComponents() {
        ...
        jtblTipoSangre = new javax.swing.JTable();
        jtxtBuscarTipoSangre = new javax.swing.JTextField();
        ...
        jlblAnalisis.setText("FORMULARIO TIPO SANGRE");
        ...
        jtblTipoSangre.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jtblTipoSangre.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtblTipoSangre.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jtblTipoSangreMousePressed(evt);
            }
        });
        jtblTipoSangre.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtblTipoSangreKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jtblTipoSangre);

        jtxtBuscarTipoSangre.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtBuscarTipoSangreKeyTyped(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jtxtBuscarTipoSangre, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtxtBuscarTipoSangre, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
...
//            }
            ...
            if (component instanceof JTextField){
                ...
                if(tf.getText().isEmpty()){
                    ...
                    if (jlblId.getText().isEmpty()){
                        try {
                            tipoSangreDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.insertTipoSangre(tipoSangreDto);
                            } catch (Exception ex) {
                                Logger.getLogger(frm_TipoSangre.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        try {
                            jtblTipoSangre.setModel(afiliadoDao.getModelTipoSangre(afiliadoDao.GetAllTipoSangre()));
                        } catch (SQLException ex) {
                            ...
                            RedisenarTablaTipoSangre();
                            SeleccionarPrimero();
                            jtblTipoSangre.getSelectionModel().addSelectionInterval(0, 0);
                            jtxtNombre.setText((String) (jtblTipoSangre.getModel().getValueAt(jtblTipoSangre.getSelectedRow(), 0)));
                            jlblId.setText(Integer.toString((int) jtblTipoSangre.getModel().getValueAt(jtblTipoSangre.getSelectedRow(), 1)));
                   
                    } else {
                        try {
                            tipoSangreDto.setId(Integer.parseInt(jlblId.getText()));
                            tipoSangreDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.updateTipoSangre(tipoSangreDto);
    ...
    private void jtblTipoSangreMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblTipoSangreMousePressed
            
        PasarACampos();
        
    }//GEN-LAST:event_jtblTipoSangreMousePressed
    ...
    private void jtxtBuscarTipoSangreKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBuscarTipoSangreKeyTyped

        
        try {
                jtblTipoSangre.setModel(afiliadoDao.filtraModelTipoSangre(jtxtBuscarTipoSangre.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(frm_TipoSangre.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            RedisenarTablaTipoSangre();
            SeleccionarPrimero();
    }//GEN-LAST:event_jtxtBuscarTipoSangreKeyTyped
    ...
    private void jbttNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttNuevo1ActionPerformed
        ...
        afiliadoDao.deleteTipoSangre(tipoSangreDto);
        try {
            jtblTipoSangre.setModel(afiliadoDao.getModelTipoSangre(afiliadoDao.GetAllTipoSangre()));
    ...
    private void jtblTipoSangreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtblTipoSangreKeyReleased
        if(evt.getKeyCode()==40||evt.getKeyCode()==38){
            
            PasarACampos();
        }
    }//GEN-LAST:event_jtblTipoSangreKeyReleased

    private void SeleccionarPrimero(){
        jtblTipoSangre.setRowSelectionInterval(0, 0);
        PasarACampos();
    ...
    private javax.swing.JTable jtblTipoSangre;
    private javax.swing.JTextField jtxtBuscarTipoSangre;
