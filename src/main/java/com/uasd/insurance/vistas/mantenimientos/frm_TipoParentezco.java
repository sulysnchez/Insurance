 ...
 * @author Sulenni
 */
public class frm_TipoParentezco extends javax.swing.JInternalFrame {
        AfiliadoDao afiliadoDao;
        Tipo_ParentezcoDto tipoParentezcoDto;
    /**
     * Creates new form frm_TipoParentezco
     */
    public frm_TipoParentezco() throws Exception {
        initComponents();
        
        afiliadoDao = new AfiliadoDao();
        tipoParentezcoDto = new Tipo_ParentezcoDto();
        
        
        jtblTipoParentezco.setModel(afiliadoDao.getModelTipoParentezco(afiliadoDao.GetAllTipoParentezco()));
        RedisenarTablaTipoParentezco();
        SeleccionarPrimero();
    }
    
    public void RedisenarTablaTipoParentezco(){
        //jtblAfiliado.setTableHeader(null);
        jtblTipoParentezco.removeColumn(jtblTipoParentezco.getColumnModel().getColumn(1));
    ...
    private void initComponents() {
        ...
        jtblTipoParentezco = new javax.swing.JTable();
        jtxtBuscarTipoParentezco = new javax.swing.JTextField();
        ...
        jlblAnalisis.setText("FORMULARIO TIPO PARENTEZCO");
        ...
        jtblTipoParentezco.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jtblTipoParentezco.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtblTipoParentezco.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jtblTipoParentezcoMousePressed(evt);
            }
        });
        jtblTipoParentezco.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtblTipoParentezcoKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jtblTipoParentezco);

        jtxtBuscarTipoParentezco.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtBuscarTipoParentezcoKeyTyped(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jtxtBuscarTipoParentezco, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtxtBuscarTipoParentezco, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
...
//            }
            ...
            if (component instanceof JTextField){
                ...
                if(tf.getText().isEmpty()){
                    ...
                    if (jlblId.getText().isEmpty()){
                        try {
                            tipoParentezcoDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.insertTipoParentezco(tipoParentezcoDto);
                            } catch (Exception ex) {
                                Logger.getLogger(frm_TipoParentezco.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        try {
                            jtblTipoParentezco.setModel(afiliadoDao.getModelTipoParentezco(afiliadoDao.GetAllTipoParentezco()));
                        } catch (SQLException ex) {
                            ...
                            RedisenarTablaTipoParentezco();
                            SeleccionarPrimero();
                            jtblTipoParentezco.getSelectionModel().addSelectionInterval(0, 0);
                            jtxtNombre.setText((String) (jtblTipoParentezco.getModel().getValueAt(jtblTipoParentezco.getSelectedRow(), 0)));
                            jlblId.setText(Integer.toString((int) jtblTipoParentezco.getModel().getValueAt(jtblTipoParentezco.getSelectedRow(), 1)));
                   
                    } else {
                        try {
                            tipoParentezcoDto.setId(Integer.parseInt(jlblId.getText()));
                            tipoParentezcoDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.updateTipoParentezco(tipoParentezcoDto);
    ...
    private void jtblTipoParentezcoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblTipoParentezcoMousePressed
            
        PasarACampos();
        
    }//GEN-LAST:event_jtblTipoParentezcoMousePressed
    ...
    private void jtxtBuscarTipoParentezcoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBuscarTipoParentezcoKeyTyped

        
        try {
                jtblTipoParentezco.setModel(afiliadoDao.filtraModelTipoParentezco(jtxtBuscarTipoParentezco.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(frm_TipoParentezco.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            RedisenarTablaTipoParentezco();
            SeleccionarPrimero();
    }//GEN-LAST:event_jtxtBuscarTipoParentezcoKeyTyped
    ...
    private void jbttNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttNuevo1ActionPerformed
        ...
        afiliadoDao.deleteTipoParentezco(tipoParentezcoDto);
        try {
            jtblTipoParentezco.setModel(afiliadoDao.getModelTipoParentezco(afiliadoDao.GetAllTipoParentezco()));
    ...
    private void jtblTipoParentezcoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtblTipoParentezcoKeyReleased
        if(evt.getKeyCode()==40||evt.getKeyCode()==38){
            
            PasarACampos();
        }
    }//GEN-LAST:event_jtblTipoParentezcoKeyReleased

    private void SeleccionarPrimero(){
        try {
            if(jtblTipoParentezco.getModel().getValueAt(0, 0)!=null){
            jtblTipoParentezco.setRowSelectionInterval(0, 0);
            PasarACampos();
        }
        } catch (Exception e) {
        }
    ...
    private javax.swing.JTable jtblTipoParentezco;
    private javax.swing.JTextField jtxtBuscarTipoParentezco;
