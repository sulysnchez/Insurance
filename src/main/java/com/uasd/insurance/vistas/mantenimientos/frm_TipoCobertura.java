 ...
 * @author Sulenni
 */
public class frm_TipoCobertura extends javax.swing.JInternalFrame {
        AfiliadoDao afiliadoDao;
        Tipo_CoberturaDto tipoCoberturaDto;
    /**
     * Creates new form frm_TipoCobertura
     */
    public frm_TipoCobertura() throws Exception {
        initComponents();
        
        afiliadoDao = new AfiliadoDao();
        tipoCoberturaDto = new Tipo_CoberturaDto();
        
        jtxtBuscarTipoCobertura.setVisible(false);
        
        jtblTipoCobertura.setModel(afiliadoDao.getModelTipoCobertura(afiliadoDao.GetAllTipoCobertura()));
        RedisenarTablaTipoCobertura();
        SeleccionarPrimero();
    }
    
    public void RedisenarTablaTipoCobertura(){
        //jtblAfiliado.setTableHeader(null);
        jtblTipoCobertura.removeColumn(jtblTipoCobertura.getColumnModel().getColumn(1));
    ...
    private void initComponents() {
        ...
        jtblTipoCobertura = new javax.swing.JTable();
        jtxtBuscarTipoCobertura = new javax.swing.JTextField();
        ...
        jlblAnalisis.setText("FORMULARIO TIPO COBERTURA");
        ...
        jtblTipoCobertura.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jtblTipoCobertura.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtblTipoCobertura.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jtblTipoCoberturaMousePressed(evt);
            }
        });
        jtblTipoCobertura.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtblTipoCoberturaKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jtblTipoCobertura);

        jtxtBuscarTipoCobertura.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtBuscarTipoCoberturaKeyTyped(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jtxtBuscarTipoCobertura, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtxtBuscarTipoCobertura, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
...
//            }
            ...
            if (component instanceof JTextField){
                ...
                if(tf.getText().isEmpty()){
                    ...
                    if (jlblId.getText().isEmpty()){
                        try {
                            tipoCoberturaDto.setPorciento(Integer.parseInt(jtxtNombre.getText()));
                            afiliadoDao.insertTipoCobertura(tipoCoberturaDto);
                            } catch (Exception ex) {
                                Logger.getLogger(frm_TipoCobertura.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        try {
                            jtblTipoCobertura.setModel(afiliadoDao.getModelTipoCobertura(afiliadoDao.GetAllTipoCobertura()));
                        } catch (SQLException ex) {
                            ...
                            RedisenarTablaTipoCobertura();
                            SeleccionarPrimero();
                            jtblTipoCobertura.getSelectionModel().addSelectionInterval(0, 0);
                            jtxtNombre.setText(Integer.toString((int) (jtblTipoCobertura.getModel().getValueAt(jtblTipoCobertura.getSelectedRow(), 0))));
                            jlblId.setText(Integer.toString((int) jtblTipoCobertura.getModel().getValueAt(jtblTipoCobertura.getSelectedRow(), 1)));
                   
                    } else {
                        try {
                            tipoCoberturaDto.setId(Integer.parseInt(jlblId.getText()));
                            tipoCoberturaDto.setPorciento(Integer.parseInt(jtxtNombre.getText()));
                            afiliadoDao.updateTipoCobertura(tipoCoberturaDto);
    ...
    private void jtblTipoCoberturaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblTipoCoberturaMousePressed
            
        PasarACampos();
        
    }//GEN-LAST:event_jtblTipoCoberturaMousePressed
    ...
    private void jtxtBuscarTipoCoberturaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBuscarTipoCoberturaKeyTyped

        
        try {
                jtblTipoCobertura.setModel(afiliadoDao.filtraModelTipoCobertura(jtxtBuscarTipoCobertura.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(frm_TipoCobertura.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            RedisenarTablaTipoCobertura();
            SeleccionarPrimero();
    }//GEN-LAST:event_jtxtBuscarTipoCoberturaKeyTyped
    ...
    private void jbttNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttNuevo1ActionPerformed
        ...
        afiliadoDao.deleteTipoCobertura(tipoCoberturaDto);
        try {
            jtblTipoCobertura.setModel(afiliadoDao.getModelTipoCobertura(afiliadoDao.GetAllTipoCobertura()));
    ...
    private void jtblTipoCoberturaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtblTipoCoberturaKeyReleased
        if(evt.getKeyCode()==40||evt.getKeyCode()==38){
            
            PasarACampos();
        }
    }//GEN-LAST:event_jtblTipoCoberturaKeyReleased

    private void SeleccionarPrimero(){
        
        try {
            if(jtblTipoCobertura.getModel().getValueAt(0, 0)!=null){
            jtblTipoCobertura.setRowSelectionInterval(0, 0);
            PasarACampos();
        }
        } catch (Exception e) {
        }
    ...
    private javax.swing.JTable jtblTipoCobertura;
    private javax.swing.JTextField jtxtBuscarTipoCobertura;
