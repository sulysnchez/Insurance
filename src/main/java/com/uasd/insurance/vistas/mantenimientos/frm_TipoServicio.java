 ...
 * @author Sulenni
 */
public class frm_TipoServicio extends javax.swing.JInternalFrame {
        AfiliadoDao afiliadoDao;
        Tipo_servicioDto tipoServicioDto;
    /**
     * Creates new form frm_TipoServicio
     */
    public frm_TipoServicio() throws Exception {
        initComponents();
        
        afiliadoDao = new AfiliadoDao();
        tipoServicioDto = new Tipo_servicioDto();
        
        
        jtblTipoServicio.setModel(afiliadoDao.getModelTipoServicio(afiliadoDao.GetAllTipoServicio()));
        RedisenarTablaTipoServicio();
        SeleccionarPrimero();
    }
    
    public void RedisenarTablaTipoServicio(){
        //jtblAfiliado.setTableHeader(null);
        jtblTipoServicio.removeColumn(jtblTipoServicio.getColumnModel().getColumn(1));
        jtblTipoServicio.removeColumn(jtblTipoServicio.getColumnModel().getColumn(1));
    ...
    private void initComponents() {
        ...
        jtxtNombreabreviado = new javax.swing.JTextField();
        ...
        jtblTipoServicio = new javax.swing.JTable();
        jtxtBuscarTipoServicio = new javax.swing.JTextField();
        ...
        jlblAnalisis.setText("FORMULARIO TIPO SERVICIO");

        jLabel3.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jLabel3.setText("Nombre abreviado");

        jtxtNombreabreviado.setFont(new java.awt.Font("Palatino Linotype", 0, 14)); // NOI18N
        jtxtNombreabreviado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtxtNombreabreviadoActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jtxtNombreabreviado, javax.swing.GroupLayout.PREFERRED_SIZE, 332, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap())))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jtxtNombreabreviado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jtblTipoServicio.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jtblTipoServicio.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtblTipoServicio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jtblTipoServicioMousePressed(evt);
            }
        });
        jtblTipoServicio.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtblTipoServicioKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jtblTipoServicio);

        jtxtBuscarTipoServicio.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtBuscarTipoServicioKeyTyped(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jtxtBuscarTipoServicio, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtxtBuscarTipoServicio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
...
//            }
            ...
            if (component instanceof JTextField){
                ...
                if(tf.getText().isEmpty()){
                    ...
                    if (jlblId.getText().isEmpty()){
                        try {
                            tipoServicioDto.setNombre(jtxtNombre.getText());
                            tipoServicioDto.setNombre_abreviado(jtxtNombreabreviado.getText());
                            afiliadoDao.insertTipoServicio(tipoServicioDto);
                            } catch (Exception ex) {
                                Logger.getLogger(frm_TipoServicio.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        try {
                            jtblTipoServicio.setModel(afiliadoDao.getModelTipoServicio(afiliadoDao.GetAllTipoServicio()));
                        } catch (SQLException ex) {
                            ...
                            RedisenarTablaTipoServicio();
                            SeleccionarPrimero();
                            jtblTipoServicio.getSelectionModel().addSelectionInterval(0, 0);
                            jtxtNombre.setText((String) (jtblTipoServicio.getModel().getValueAt(jtblTipoServicio.getSelectedRow(), 0)));
                            jlblId.setText(Integer.toString((int) jtblTipoServicio.getModel().getValueAt(jtblTipoServicio.getSelectedRow(), 1)));
                   
                    } else {
                        try {
                            tipoServicioDto.setId(Integer.parseInt(jlblId.getText()));
                            tipoServicioDto.setNombre(jtxtNombre.getText());
                            tipoServicioDto.setNombre_abreviado(jtxtNombreabreviado.getText());
                            afiliadoDao.updateTipoServicio(tipoServicioDto);
    ...
    private void jtblTipoServicioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblTipoServicioMousePressed
            
        PasarACampos();
        
    }//GEN-LAST:event_jtblTipoServicioMousePressed

    private void PasarACampos(){
        jtxtNombre.setText((String) (jtblTipoServicio.getModel().getValueAt(jtblTipoServicio.getSelectedRow(), 0)));
        jlblId.setText(Integer.toString((int) jtblTipoServicio.getModel().getValueAt(jtblTipoServicio.getSelectedRow(), 1)));
        jtxtNombreabreviado.setText(((String) jtblTipoServicio.getModel().getValueAt(jtblTipoServicio.getSelectedRow(), 2)));
        
        tipoServicioDto.setId(Integer.parseInt(jlblId.getText()));
        tipoServicioDto.setNombre(jtxtNombre.getText());
        tipoServicioDto.setNombre_abreviado(jtxtNombreabreviado.getText());
    }
    private void jtxtBuscarTipoServicioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBuscarTipoServicioKeyTyped
            try {
                jtblTipoServicio.setModel(afiliadoDao.filtraModelTipoServicio(jtxtBuscarTipoServicio.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(frm_TipoServicio.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            RedisenarTablaTipoServicio();
            SeleccionarPrimero();
    }//GEN-LAST:event_jtxtBuscarTipoServicioKeyTyped
    ...
    private void jbttNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttNuevo1ActionPerformed
        ...
        afiliadoDao.deleteTipoServicio(tipoServicioDto);
        try {
            jtblTipoServicio.setModel(afiliadoDao.getModelTipoServicio(afiliadoDao.GetAllTipoServicio()));
    ...
    private void jtblTipoServicioKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtblTipoServicioKeyReleased
        if(evt.getKeyCode()==40||evt.getKeyCode()==38){
            
            PasarACampos();
        }
    }//GEN-LAST:event_jtblTipoServicioKeyReleased

    private void jtxtNombreabreviadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtxtNombreabreviadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtxtNombreabreviadoActionPerformed

    private void SeleccionarPrimero(){
        
        try {
            if(jtblTipoServicio.getModel().getValueAt(0, 0)!=null){
            jtblTipoServicio.setRowSelectionInterval(0, 0);
            PasarACampos();
        }
        } catch (Exception e) {
        }
    ...
    private javax.swing.JTable jtblTipoServicio;
    private javax.swing.JTextField jtxtBuscarTipoServicio;
    private javax.swing.JTextField jtxtNombre;
    private javax.swing.JTextField jtxtNombreabreviado;
