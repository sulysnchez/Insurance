 ...
 * @author Sulenni
 */
public class frm_TipoAfiliacion extends javax.swing.JInternalFrame {
        AfiliadoDao afiliadoDao;
        Tipo_AfiliacionDto tipoAfiliacionDto;
    /**
     * Creates new form frm_TipoAfiliacion
     */
    public frm_TipoAfiliacion() throws Exception {
        initComponents();
        
        afiliadoDao = new AfiliadoDao();
        tipoAfiliacionDto = new Tipo_AfiliacionDto();
        
        
        jtblTipoAfiliacion.setModel(afiliadoDao.getModelTipoAfiliacion(afiliadoDao.GetAllTipoAfiliacion()));
        RedisenarTablaTipoAfiliacion();
        SeleccionarPrimero();
    }
    
    public void RedisenarTablaTipoAfiliacion(){
        //jtblAfiliado.setTableHeader(null);
        jtblTipoAfiliacion.removeColumn(jtblTipoAfiliacion.getColumnModel().getColumn(1));
    ...
    private void initComponents() {
        ...
        jtblTipoAfiliacion = new javax.swing.JTable();
        jtxtBuscarTipoAfiliacion = new javax.swing.JTextField();
        ...
        jlblAnalisis.setText("FORMULARIO TIPO AFILIACION");
        ...
        jtblTipoAfiliacion.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jtblTipoAfiliacion.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtblTipoAfiliacion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jtblTipoAfiliacionMousePressed(evt);
            }
        });
        jtblTipoAfiliacion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtblTipoAfiliacionKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jtblTipoAfiliacion);

        jtxtBuscarTipoAfiliacion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtBuscarTipoAfiliacionKeyTyped(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jtxtBuscarTipoAfiliacion, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtxtBuscarTipoAfiliacion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
...
//            }
            ...
            if (component instanceof JTextField){
                ...
                if(tf.getText().isEmpty()){
                    ...
                    if (jlblId.getText().isEmpty()){
                        try {
                            tipoAfiliacionDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.insertTipoAfiliacion(tipoAfiliacionDto);
                            } catch (Exception ex) {
                                Logger.getLogger(frm_TipoAfiliacion.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        try {
                            jtblTipoAfiliacion.setModel(afiliadoDao.getModelTipoAfiliacion(afiliadoDao.GetAllTipoAfiliacion()));
                        } catch (SQLException ex) {
                            ...
                            RedisenarTablaTipoAfiliacion();
                            SeleccionarPrimero();
                            jtblTipoAfiliacion.getSelectionModel().addSelectionInterval(0, 0);
                            jtxtNombre.setText((String) (jtblTipoAfiliacion.getModel().getValueAt(jtblTipoAfiliacion.getSelectedRow(), 0)));
                            jlblId.setText(Integer.toString((int) jtblTipoAfiliacion.getModel().getValueAt(jtblTipoAfiliacion.getSelectedRow(), 1)));
                   
                    } else {
                        try {
                            tipoAfiliacionDto.setId(Integer.parseInt(jlblId.getText()));
                            tipoAfiliacionDto.setNombre(jtxtNombre.getText());
                            afiliadoDao.updateTipoAfiliacion(tipoAfiliacionDto);
    ...
    private void jtblTipoAfiliacionMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblTipoAfiliacionMousePressed
            
        PasarACampos();
        
    }//GEN-LAST:event_jtblTipoAfiliacionMousePressed
    ...
    private void jtxtBuscarTipoAfiliacionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBuscarTipoAfiliacionKeyTyped

        
        try {
                jtblTipoAfiliacion.setModel(afiliadoDao.filtraModelTipoAfiliacion(jtxtBuscarTipoAfiliacion.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(frm_TipoAfiliacion.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            RedisenarTablaTipoAfiliacion();
            SeleccionarPrimero();
    }//GEN-LAST:event_jtxtBuscarTipoAfiliacionKeyTyped
    ...
    private void jbttNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttNuevo1ActionPerformed
        ...
        afiliadoDao.deleteTipoAfiliacion(tipoAfiliacionDto);
        try {
            jtblTipoAfiliacion.setModel(afiliadoDao.getModelTipoAfiliacion(afiliadoDao.GetAllTipoAfiliacion()));
    ...
    private void jtblTipoAfiliacionKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtblTipoAfiliacionKeyReleased
        if(evt.getKeyCode()==40||evt.getKeyCode()==38){
            
            PasarACampos();
        }
    }//GEN-LAST:event_jtblTipoAfiliacionKeyReleased

    private void SeleccionarPrimero(){
        
        try {
            if(jtblTipoAfiliacion.getModel().getValueAt(0, 0)!=null){
            jtblTipoAfiliacion.setRowSelectionInterval(0, 0);
            PasarACampos();
        }
        } catch (Exception e) {
        }
    ...
    private javax.swing.JTable jtblTipoAfiliacion;
    private javax.swing.JTextField jtxtBuscarTipoAfiliacion;
